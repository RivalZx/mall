...
public class GeneratorTest {
		...
		public void run() {
				...
				//1、配置数据源
				FastAutoGenerator.create("jdbc:mysql://localhost:3306/mall", "root", "Hzx199754,")
						//2、全局配置
						.globalConfig(builder -> {
							builder.author("hezx") // 设置作者名
						...
						.strategyConfig(builder -> {
							builder.addInclude("mmall_user") // 设置需要生成的数据表名
